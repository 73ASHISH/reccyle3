<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="uaccount.aspx.cs" Inherits="RecycleRewardHub.uaccount" %>
...
<!--Profile Section-->
  ...
  <asp:DetailsView ID="DetailsView1" runat="server" Height="318px" Width="367px" 
      ...
      <FieldHeaderStyle CssClass="bg-dark text-light" />
      <Fields>
  ...
  <div></div>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT * FROM [useress] WHERE ([userid] = @userid)" 
